...
// Cross Module References
	WITCH_HUNT_API UClass* Z_Construct_UClass_ACampFire_NoRegister();
	WITCH_HUNT_API UClass* Z_Construct_UClass_ACampFire();
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	UPackage* Z_Construct_UPackage__Script_Witch_Hunt();
	WITCH_HUNT_API UFunction* Z_Construct_UFunction_ACampFire_ApplyFireDamage();
	WITCH_HUNT_API UFunction* Z_Construct_UFunction_ACampFire_OnOverlapBegin();
	ENGINE_API UScriptStruct* Z_Construct_UScriptStruct_FHitResult();
	ENGINE_API UClass* Z_Construct_UClass_UPrimitiveComponent_NoRegister();
	ENGINE_API UClass* Z_Construct_UClass_AActor_NoRegister();
	WITCH_HUNT_API UFunction* Z_Construct_UFunction_ACampFire_OnOverlapEnd();
...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ACampFire_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ACampFire_OnOverlapBegin, "OnOverlapBegin" }, // 2026755477
		{ &Z_Construct_UFunction_ACampFire_OnOverlapEnd, "OnOverlapEnd" }, // 676616468
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ACampFire, 5642137);
	static FCompiledInDefer Z_CompiledInDefer_UClass_ACampFire(Z_Construct_UClass_ACampFire, &ACampFire::StaticClass, TEXT("/Script/Witch_Hunt"), TEXT("ACampFire"), false, nullptr, nullptr, nullptr);
